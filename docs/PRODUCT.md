...
Phase 4E.1 adds no React organization controls, archived-history page, Search UI/backend, FTS, pagination, Delete, tags, folders, groups, or bulk actions. Those product surfaces require a separately accepted Phase 4E.2; normal UI must not advertise the new mutations yet.
