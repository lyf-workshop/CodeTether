...
- Project discovery/scanning, Project or Location rename/relocate, multi-root Locations on one Machine, remote Project or Conversation execution, SSH, LAN discovery, relay, file synchronization, generic remote control, or Provider execution on a remote Machine.
